...
export const THEMES: Theme[] = [
  ...
  },
  {
    id: 'contrast',
    name: 'High contrast',
    description: 'Grey page, white cards, dark borders — maximum separation',
    vars: {
      '--t-bg': '#d9d7d1',
      '--t-surf': '#ffffff',
      '--t-surf2': '#eeece6',
      ...
      '--t-txt2': '#2e2c27',
      '--t-muted': '#5f5b52',
      '--t-acc': 'oklch(0.45 0.17 264)',
      '--t-acc-bg': 'oklch(0.9 0.04 264)',
      '--t-acc-dk': 'oklch(0.35 0.15 264)',
      '--t-acc-fo': 'oklch(0.8 0.07 264)',
      '--t-success': 'oklch(0.45 0.16 150)',
      '--t-success-bg': 'oklch(0.9 0.06 150)',
      '--t-amber': 'oklch(0.42 0.14 85)',
      '--t-amber-bg': 'oklch(0.9 0.07 85)',
      '--t-amber-brd': 'oklch(0.8 0.09 85)',
      '--t-urgent': 'oklch(0.42 0.2 20)',
      '--t-urgent-bg': 'oklch(0.92 0.06 20)',
      '--t-important': 'oklch(0.36 0.16 264)',
      '--t-important-bg': 'oklch(0.9 0.05 264)',
      '--t-quick': 'oklch(0.38 0.16 145)',
      '--t-quick-bg': 'oklch(0.9 0.06 145)',
      '--t-kind-task': 'oklch(0.36 0.16 240)',
      '--t-kind-task-bg': 'oklch(0.9 0.05 240)',
      '--t-kind-reminder': 'oklch(0.42 0.15 75)',
      '--t-kind-reminder-bg': 'oklch(0.92 0.06 75)',
      '--t-kind-resp': 'oklch(0.38 0.14 185)',
      '--t-kind-resp-bg': 'oklch(0.9 0.05 185)',
    },
  },
  {
    id: 'dark',
