...
const STEPS: TourStep[] = [
  ...
  { view: 'feed', target: '[data-tour="sidebar"]', placement: 'right', title: 'The sidebar', body: 'Nine views — press 1–9 anywhere: Home, Feed, Explore (⌘F search), Kanban, Table, Quick Help, Archive, Docs, Settings. Click the edge to collapse it.' },
