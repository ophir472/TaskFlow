...
const STEPS: TourStep[] = [
  ...
  { view: 'feed', target: '[data-tour="sidebar"]', placement: 'right', title: 'The sidebar', body: 'All your views — press 1–9 anywhere: Home, Feed, Explore (⌘F search), Kanban, Table, Quick Help, Archive, Docs, Settings; plus the ▣ Hub (tickets & waits, click it in the sidebar). Click the edge to collapse it.' },
